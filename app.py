...
+ one-step metabolite screen + OECD QMRF documentation tab + Report Export.
Run:  python app.py
"""
        ...
        html.Div(
            ...
            children=[
                ...
                html.P(
                    ...
                    "combines a 3-model GNN ensemble trained on ~6,500 Ames experiments with "
                    "expert structural-alert rules (ICH M7 two-methodology), a one-step "
                    "metabolite screen for pro-mutagens, and a reliability score based on "
        ...
        html.Div(
            ...
            children=[
                ...
                html.P("Paste a SMILES string (or click a chip), then press Predict. "
                       "Red atoms pushed toward the verdict, blue away from it. "
                       "A wide ± spread means the ensemble disagrees; a 'pro-mutagen' verdict "
                       "means a predicted metabolite is the toxic species.", className="hint"),
